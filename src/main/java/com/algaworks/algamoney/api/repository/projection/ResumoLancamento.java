...
/*Essa classe eh uma "MODEL" alternativa para devolvermos um resource resumido, 
 * sem as ligacoes com elementos, tornando o response mais simples
 * 
 * É usado no lancamento repository query*/
